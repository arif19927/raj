...
MONGO_URI = 'mongodb+srv://Magic:Spike@cluster0.fa68l.mongodb.net/name?retryWrites=true&w=majority&appName=Cluster0'
...
async def attack(update: Update, context: CallbackContext):
    ...
    if argument_type == 3:
        attack_command = f"./name {ip} {port} {duration} "
    elif argument_type == 4:
        attack_command = f"./name {ip} {port} {duration} {threads} "
    elif argument_type == 5:
        attack_command = f"./name {ip} {port} {duration} {byte_size} {threads} "
